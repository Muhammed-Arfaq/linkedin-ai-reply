...
//     const showAIIcon = (inputField: HTMLElement) => {
//       try {
//         if (!aiIcon) {
//           aiIcon = createAIIcon();
//           if (aiIcon) document.body.appendChild(aiIcon);
//         }
//         if (!aiIcon) return;

//         const rect = inputField.getBoundingClientRect();
//         aiIcon.style.position = 'fixed';
//         aiIcon.style.left = `${rect.right - 52}px`;
//         aiIcon.style.top = `${rect.bottom - 52}px`;
//         aiIcon.style.display = 'block';

//         aiIcon.onclick = () => {
//           try {
//             console.log('Sending message to background script'); // Debugging
...
//             });
//           } catch (error) {
//             console.error('Error in AI icon click handler:', error);
//           }
//         };
//         console.log('AI icon shown');
//       } catch (error) {
//         console.error('Error showing AI icon:', error);
//       }
//     };
...
//           console.log('AI icon hidden');
//         }
//       } catch (error) {
//         console.error('Error hiding AI icon:', error);
//       }
//     };
...
//     // Check for the message input field based on class, contenteditable, and role attributes
//     if (
//       target.classList.contains('msg-form__contenteditable') &&
//       target.getAttribute('contenteditable') === 'true' &&
//       target.getAttribute('role') === 'textbox'
//     ) {
//       console.log('Focusin on LinkedIn message input');
//       showAIIcon(target);
//     }
//   } catch (error) {
...
//           target.getAttribute('role') === 'textbox'
//         ) {
//           console.log('Focusout from LinkedIn message input');
//           setTimeout(() => {
//             if (!document.activeElement?.classList.contains('msg-form__contenteditable')) {
//               hideAIIcon();
//             }
//           }, 100);
//         }
//       } catch (error) {
//         console.error('Error in focusout event listener:', error);
//       }
//     });
...
//           if (activeElement?.getAttribute('role') === 'textbox' && activeElement.closest('.msg-form__contenteditable')) {
//             activeElement.textContent += message.text;
//             const inputEvent = new Event('input', { bubbles: true });
//             activeElement.dispatchEvent(inputEvent);
//             console.log('Text inserted into message input');
//           }
//         }
//       } catch (error) {
//         console.error('Error handling insertText message:', error);
//       }
//     });
//   },
// });
...
//         <textarea id="ai-input" rows="4" style="width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ccc; border-radius: 4px;"></textarea>
//         <button id="ai-generate" style="background-color: #2563EB; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">Generate</button>
//       `;
...
//         alert('Generate button clicked!'); // You can replace this with actual AI generation logic.
//         modalOverlay.remove(); // Close the modal after generating.
//       });
//     };
...
//     const targetLinkedInMessageBox = () => {
//       const messageBox = document.querySelector('[contenteditable="true"]'); // Example LinkedIn message box selector
//       if (messageBox) {
//         showAIIcon(messageBox as HTMLElement);
//       }
//     };

//     // Monitor for focus on LinkedIn message input
//     document.addEventListener('focusin', (event) => {
//       const target = event.target as HTMLElement;
//       if (target.getAttribute('contenteditable') === 'true') {
//         targetLinkedInMessageBox();
//       }
//     });
//   },
// });
